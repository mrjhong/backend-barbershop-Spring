...
public class ProductoController {
    ...
    public ResponseEntity<?> create(@RequestBody ProductoDto productoDto){
        ...
        if(StringUtils.isBlank(productoDto.getFoto()))
            return new ResponseEntity(new Mensaje("la ruta de imagen es nessesaria"), HttpStatus.BAD_REQUEST);
       
        if(productoService.existsByNombre(productoDto.getNombre()))
            return new ResponseEntity(new Mensaje("ese nombre ya existe"), HttpStatus.BAD_REQUEST);
        Producto producto = new Producto(productoDto.getNombre(), productoDto.getPrecio(),productoDto.getFoto(),productoDto.getDescripcion());
